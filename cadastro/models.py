...
class Cadastro(models.Model):
    ...
    especie = models.CharField(max_length=100, help_text='Caso seja cão ou gato, ponha a raça, se não, a espécie.',
                               verbose_name='Raça/Espécie')

    peso = models.FloatField(help_text='Peso do animal em kg', verbose_name='Peso')

    foto = models.ImageField(upload_to=upload_imagem_animal, blank=True,
                             null=True)  # Importação de imagem do animal para animal (blank=True faz com que seja aceito sem a foto)
